...
class ReportExportService {
  ...
  Future<Uint8List> _buildExcelBytes(ReportExportPayload payload) async {
    ...
    rawSheet.appendRow([
      ...
      TextCellValue('Daya Mampu Pasok (kW)'),
    ...
    for (final item in payload.records) {
      rawSheet.appendRow([
        ...
        TextCellValue(item.machineDispatchCapacity.isNotEmpty ? item.machineDispatchCapacity : item.machineAvailableCapacity),
        ...
        TextCellValue(item.jamKerjaMesin > 0 ? item.jamKerjaMesin.toStringAsFixed(1) : '-'),
